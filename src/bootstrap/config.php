...
function CheckAuthentication()
{
	...
	return \Xjtuwangke\LaravelCkeditor\CKFinder\Authorize::isAuthorized();
}

// LicenseKey : Paste your license key here. If left blank, CKFinder will be
// fully functional, in demo mode.
$config['LicenseName'] = \Config::get('laravel-ckeditor::config.LicenseName');
$config['LicenseKey']  = \Config::get('laravel-ckeditor::config.LicenseKey');
...
$baseUrl = rtrim( \URL::to( 'upload/' . \Config::get('laravel-ckeditor::config.path') . '/' ) , '/' ) . '/';
